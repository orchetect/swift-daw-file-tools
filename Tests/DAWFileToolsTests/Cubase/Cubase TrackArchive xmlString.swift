...
@Suite
struct Cubase_TrackArchive_xmlString {
    @Test
    func xmlString_ZeroStartTime() throws {
        ...
        let marker1 = try Cubase.TrackArchive.Marker(
            name: "Marker1",
            startTimecode: Timecode(.components(f: 12), at: .fps24),
            startRealTime: nil
        )
        markerTrack.events.append(.marker(marker1))

        let marker2 = try Cubase.TrackArchive.Marker(
            name: "Marker2",
            startTimecode: Timecode(.components(s: 1), at: .fps24),
            startRealTime: nil
        )
    ...
    @Test
    func xmlString_NonZeroStartTime() throws {
        var trackArchive = Cubase.TrackArchive()
        ...
        let marker1 = try Cubase.TrackArchive.Marker(
            name: "Marker1",
            startTimecode: Timecode(.components(h: 23, s: 1), at: .fps24),
            startRealTime: nil
        )
        markerTrack.events.append(.marker(marker1))
        ...
        let marker2 = try Cubase.TrackArchive.Marker(
            name: "Marker2",
            startTimecode: Timecode(.components(h: 00), at: .fps24),
            startRealTime: nil
        )
        markerTrack.events.append(.marker(marker2))

        let marker3 = try Cubase.TrackArchive.Marker(
            name: "Marker3",
            startTimecode: Timecode(.components(h: 00, s: 1), at: .fps24),
            startRealTime: nil
        )
