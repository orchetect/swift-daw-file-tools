...
@Suite
struct Cubase_TrackArchive_ConvertingDAWMarkers {
    @Test
    func convertingDAWMarkers_IncludeComments_NoComments() throws {
        let dawMarkers: [DAWMarker] = [
            DAWMarker(
                storage: .init(value: .realTime(relativeToStart: 0.5), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker1",
                comment: nil
            ),
            DAWMarker(
                storage: .init(value: .realTime(relativeToStart: 1.0), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker2",
                comment: nil
            )
        ]
    ...
    @Test
    func convertingDAWMarkers_IncludeComments_WithComments() throws {
        let dawMarkers: [DAWMarker] = [
            DAWMarker(
                storage: .init(value: .realTime(relativeToStart: 0.5), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker1",
    ...
    @Test
    func convertingDAWMarkers_IncludeComments_SeparateCommentsTrack_VariedComments() throws {
        let dawMarkers: [DAWMarker] = [
            DAWMarker(
                storage: .init(value: .realTime(relativeToStart: 0.5), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker1",
    ...
    @Test
    func convertingDAWMarkers_DoNotIncludeComments_WithComments() throws {
        let dawMarkers: [DAWMarker] = [
            DAWMarker(
                storage: .init(value: .realTime(relativeToStart: 0.5), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker1",
    ...
    @Test
    func convertingDAWMarkers_TimecodeStorage() throws {
        let dawMarkers: [DAWMarker] = [
            DAWMarker(
                storage: .init(value: .timecodeString(absolute: "00:00:00:12"), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker1",
                comment: nil
            ),
            DAWMarker(
                storage: .init(value: .timecodeString(absolute: "00:00:01:00"), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker2",
                comment: nil
            )
        ]
    ...
    @Test
    func convertingDAWMarkers_NonZeroTimelineStart() throws {
        let dawMarkers: [DAWMarker] = [
            DAWMarker(
                storage: .init(value: .timecodeString(absolute: "00:00:00:12"), frameRate: .fps24, base: .max80SubFrames),
                name: "Marker1",
        ...
        var buildMessages: [Cubase.TrackArchive.EncodeMessage] = []
        let trackArchive = try Cubase.TrackArchive(
            converting: dawMarkers,
            at: .fps24,
            startTimecode: Timecode(.components(h: 23), at: .fps24),
            includeComments: true,
            separateCommentsTrack: false,
            buildMessages: &buildMessages
        )
