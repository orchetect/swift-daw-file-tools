...
@Suite
struct DAWMarker_Conversions_Tests {
    /// Same frame rate.
    @Test
    func resolvedTimecodeA() throws {
    ...
    @Test
    func originalTimecode_Fraction() throws {
        let sfBase: Timecode.SubFramesBase = .max80SubFrames
    ...
    @Test
    func resolvedTimecode_Fraction() throws {
        let sfBase: Timecode.SubFramesBase = .max80SubFrames
