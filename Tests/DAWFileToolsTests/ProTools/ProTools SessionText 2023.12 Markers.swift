...
@Suite
struct ProTools_SessionText_2023_12_Markers {
    @Test
    func sessionText() throws {
        // load file
        ...
        #expect(
            try markers[safe: 0]
                == ProTools.SessionInfo.Marker(
                    number: 1,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 00, f: 00), at: .fps24)),
                    timeReference: .samples(480_000),
                    name: "Marker 1",
                    trackName: "Markers",
                    trackType: .ruler,
                    comment: nil
        ...
        #expect(
            try markers[safe: 1]
                == ProTools.SessionInfo.Marker(
                    number: 2,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 01, f: 00), at: .fps24)),
                    timeReference: .samples(528_000),
                    name: "Marker 2",
                    trackName: "Markers 2",
                    trackType: .ruler,
        ...
        #expect(
            try markers[safe: 2]
                == ProTools.SessionInfo.Marker(
                    number: 3,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 02, f: 00), at: .fps24)),
                    timeReference: .samples(576_000),
                    name: "Marker 3",
                    trackName: "Markers 3",
                    trackType: .ruler,
                    comment: nil
        ...
        #expect(
            try markers[safe: 3]
                == ProTools.SessionInfo.Marker(
                    number: 4,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 03, f: 00), at: .fps24)),
                    timeReference: .samples(624_000),
                    name: "Marker 4",
                    trackName: "Markers 4",
                    trackType: .ruler,
                    comment: nil
        ...
        #expect(
            try markers[safe: 4]
                == ProTools.SessionInfo.Marker(
                    number: 5,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 04, f: 00), at: .fps24)),
                    timeReference: .samples(672_000),
                    name: "Marker 5",
                    trackName: "Markers 5",
                    trackType: .ruler,
                    comment: nil
        ...
        #expect(
            try markers[safe: 5]
                == ProTools.SessionInfo.Marker(
                    number: 6,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 05, f: 00), at: .fps24)),
                    timeReference: .samples(720_000),
                    name: "Marker 6",
                    trackName: "Audio 1",
                    trackType: .track,
        ...
        #expect(
            try markers[safe: 6]
                == ProTools.SessionInfo.Marker(
                    number: 7,
                    location: .timecode(ProTools.formTimecode(.init(h: 1, m: 00, s: 06, f: 00), at: .fps24)),
                    timeReference: .samples(768_000),
                    name: "Marker 7",
                    trackName: "Audio 2",
                    trackType: .track,
                    comment: nil
    ...
    @Test
    func dawMarkerTrackConversion() throws {
        // load file
